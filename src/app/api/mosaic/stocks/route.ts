  ...
  try {
    ...
    return NextResponse.json({
      items: [
        ...
        { symbol:'AVGO', price:170.2, changePct:0.51 },  { symbol:'BRK.B', price:418.2, changePct:0.20 },
        { symbol:'JPM',  price:206.3, changePct:-0.84 }, { symbol:'V',    price:278.0, changePct:0.66 },
        { symbol:'MA',   price:448.4, changePct:0.60 },  { symbol:'UNH',  price:497.1, changePct:-0.22 },
        { symbol:'LLY',  price:912.2, changePct:0.45 },  { symbol:'XOM',  price:113.2, changePct:-0.35 },
        { symbol:'CVX',  price:154.9, changePct:-0.28 }, { symbol:'WMT',  price:69.2,  changePct:0.18 },
        { symbol:'HD',   price:337.5, changePct:0.12 },  { symbol:'KO',   price:63.7,  changePct:0.09 },
